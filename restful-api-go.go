...
var events = allEvents{
	{
		...
		Description: "We are building a restful api with Go and starting to get a feel for how it works, and how to build cool and performant apps for the future.",
	},
	{
		ID:          "2",
		Title:       "Meet friends in park for pick up frisbee games.",
